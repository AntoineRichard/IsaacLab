...
from isaaclab.managers.manager_term_cfg import CurriculumTermCfg as CurrTerm
from isaaclab.utils.configclass import configclass

from isaaclab_tasks.manager_based.classic.cartpole.cartpole_env_cfg import CartpoleEnvCfg
from isaaclab.envs.mdp.curriculums import modify_env_param, modify_term_cfg
from isaaclab.envs.mdp.observations import joint_pos, joint_pos_rel
...
class CurriculumsCfg:
    modify_observation_joint_pos = CurrTerm(
        ...
        params={
            ...
            "modify_params": {"value": joint_pos, "num_steps": 1},
        },
    )
    ...
    with torch.inference_mode():
        for count in range(3):
            ...
            if count == 0:
                ...
                assert env.observation_manager.cfg.policy.joint_pos_rel.func == joint_pos_rel
            ...
            if count == 2:
                ...
                assert env.observation_manager.cfg.policy.joint_pos_rel.func == joint_pos
                joint_ids = env.event_manager.cfg.reset_cart_position.params["asset_cfg"].joint_ids
