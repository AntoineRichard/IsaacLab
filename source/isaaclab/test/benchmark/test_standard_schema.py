...
def test_manifest_round_trip(tmp_path):
    """Manifest round-trips with nested config/machine/phases."""
    m = Manifest(
        run_id="rsl-rl_physx_Isaac-Ant-Direct-v0_20260422-131500_seed42",
        ...
        machine=ManifestMachine(hostname="valkyrie-03", git_commit="abc", git_branch="antoiner/feat/odin"),
        phases={
            "startup": ManifestPhase(file="startup.json", status="completed", duration_s=48.7, exit_code=0),
            "training": ManifestPhase(file="training.json", status="completed", duration_s=1942.1, exit_code=0),
        },
