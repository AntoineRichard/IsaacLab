...
.. code-block:: bash
    ...
    ./isaaclab.sh -p scripts/tutorials/01_assets/run_deformable_object.py --backend newton

    # Usage with OvPhysX physics without a visualizer.
    ./isaaclab.sh -p scripts/tutorials/01_assets/run_deformable_object.py --backend ovphysx
...
parser.add_argument(
    "--backend", type=str, default="physx", choices=["physx", "newton", "ovphysx"], help="Physics backend."
)
...
args_cli.physics = {"physx": "physx", "newton": "newton_vbd", "ovphysx": "ovphysx"}[args_cli.backend]
