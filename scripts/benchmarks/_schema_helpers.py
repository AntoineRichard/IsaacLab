...
"""Shared helpers for the Odin v1.0 benchmark bundle writers.
...
from isaaclab.test.benchmark.standard_schema import GpuDeviceInfo, Hardware, Versions
...
def synth_run_id(framework: str, backend: str, task: str, seed: int) -> str:
    ...
    Format mirrors :func:`tools.odin.common.run_id.compute_run_id`.
    """
